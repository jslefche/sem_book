...
In both cases, we obtain a $b = 0.0981$ suggesting that a full shift in $x$ along its range would only result in a predicted shift of 10% along the range of $y$.

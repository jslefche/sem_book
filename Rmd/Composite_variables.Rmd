...
For the moment, composites are not directly implemented in *piecewiseSEM* but we hope to shortly. In the interim, it is easy to compute them by hand, as above, extract the predicted scores, and use them as any other predictor. 

...
To demonstrate the functionality of this package, let's use the data from Grace & Keeley (2005), which is included in the *piecewiseSEM* package:
```{r}

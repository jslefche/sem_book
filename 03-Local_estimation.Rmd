...
We'll work from the random dataset generated in the supplements for the paper by Shipley and Douma. First, let's generate the data:
...
You'll note that there is a mix of linear and non-linear variables, including Poisson- and binomial-distributed ones.

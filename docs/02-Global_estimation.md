...
If we return to our previous path model, which reinstates the path between $y1 -> y2$, the total effect of $x1$ on $y2$ includes the direct effect as well as the indirect effect mediated by $y1$. 
